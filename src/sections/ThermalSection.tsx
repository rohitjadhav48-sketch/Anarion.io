...
const ThermalSection = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={watermarkRef}
        className="absolute right-[6vw] bottom-[10vh] font-heading font-bold text-anarion-text pointer-events-none select-none"
        style={{ 
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-[4vw]">
        ...
        >
          <span className="word inline-block">110°C</span>{' '}
          <span className="word inline-block">and</span>{' '}
          <span className="word inline-block">Still</span>{' '}
          <span className="word inline-block">stable.</span>
        </h2>
        ...
        >
          High-temperature aging is where standard formulations fail. Anarion's perovskite 
          retains the structural integrity under continuous thermal stress so your modules 
